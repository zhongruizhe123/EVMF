...
from loss.loss import LabelSmoothing, SimpleLossCompute, SimpleLossCompute_memory
from scheduler.lr_scheduler import SimpleScheduler
from epoch_loop.run_epoch import training_loop, validation_next_word_loop, greedy_decoder, validation_next_word_loop_crossloss
...
def main(cfg):
    ...
    # loss_compute_memory = SimpleLossCompute_memory(criterion, lr_scheduler)
    ...
    for epoch in range(cfg.start_epoch, cfg.epoch_num):
        ...
        # val_1_loss_cross = validation_next_word_loop_crossloss(
